...
const Purchase: NavigationFunctionComponent<Props> = ({componentId}) => {
  ...
  const [selectedAddress, setSelectedAddress] = useState<IAddress>(addressState.addresses[0]);
            ...
            <View style={styles.addressContainer}>
              {
                ...
                ?
                  <TouchableWithoutFeedback onPress={() => openAddressPicker()} style={{flex: 1, flexDirection: 'column'}}>
                    <View style={{marginTop: 5}}>
                      ...
                      <View style={{marginLeft: 'auto'}}>
                        <Icon name='caret-down-outline' size={30} color={colors.PRODUCT_PRICE_TEXT}/>
                      </View>
                      </View>
                    </View>
